    ...
    <div className='flex justify-center mb-6'>
      ...
      {!image ? (
        <div className='w-20 h-20 flex items-center justify-center bg-orange-50 rounded-full relative cursor-pointer'>
          ...
          <button
            type='button'
            className='w-8 h-8 flex items-center justify-center bg-gradient-to-r from-orange-500/50 to-orange-600 text-white rounded-full absolute -bottom-1 -right-1 cursor-pointer'
